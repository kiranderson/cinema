...
<script>
  ...
  "description": "Основными направлениями нашей работы являются организация и проведение рекламных съемок, съемок художественных и документальных фильмов, аэрофотосъемка",
